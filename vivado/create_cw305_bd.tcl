...
disconnect_bd_net /sys_clk_1 [get_bd_pins axi_gpio/s_axi_aclk]
disconnect_bd_net /rst_sys_clk_peripheral_aresetn [get_bd_pins axi_gpio/s_axi_aresetn]
...
connect_bd_intf_net -intf_net axi_smc_data_M01_AXI [get_bd_intf_pins axi_smc_data/M01_AXI] [get_bd_intf_pins axi_buffer_0/S_AXI]
connect_bd_intf_net -intf_net axi_smc_data_M02_AXI [get_bd_intf_pins axi_smc_data/M02_AXI] [get_bd_intf_pins axi_lfsr_0/S00_AXI]
connect_bd_intf_net -intf_net axi_smc_data_M03_AXI [get_bd_intf_pins axi_smc_data/M03_AXI] [get_bd_intf_pins axi_gpio/S_AXI]
...
## clock signals
connect_bd_net -net core_clk [get_bd_pins pll/clk_out2] [get_bd_pins VexRiscv_Core_0/m_inst_axi_aclk] [get_bd_pins VexRiscv_Core_0/m_data_axi_aclk] [get_bd_pins axi_smc_data/aclk] [get_bd_pins axi_dmem_ctrl/s_axi_aclk] [get_bd_pins axi_smc_inst/aclk] [get_bd_pins axi_imem_ctrl/s_axi_aclk] [get_bd_pins axi_rom_ctrl/s_axi_aclk] [get_bd_pins axi_buffer_0/s_axi_aclk] [get_bd_pins axi_lfsr_0/s00_axi_aclk] [get_bd_pins axi_gpio/s_axi_aclk] [get_bd_pins usb_interface_0_axi_periph/M01_ACLK] [get_bd_pins usb_interface_0_axi_periph/M02_ACLK] [get_bd_pins rst_core_clk/slowest_sync_clk]

connect_bd_net [get_bd_pins pll/clk_out1] [get_bd_pins VexRiscv_Core_0/s_ctrl_axi_aclk]

## reset signals
connect_bd_net [get_bd_pins rst_core_clk/peripheral_aresetn] [get_bd_pins VexRiscv_Core_0/m_data_axi_aresetn] [get_bd_pins axi_dmem_ctrl/s_axi_aresetn] [get_bd_pins axi_smc_data/aresetn] [get_bd_pins VexRiscv_Core_0/m_inst_axi_aresetn] [get_bd_pins axi_imem_ctrl/s_axi_aresetn] [get_bd_pins axi_rom_ctrl/s_axi_aresetn] [get_bd_pins axi_smc_inst/aresetn] [get_bd_pins axi_buffer_0/s_axi_aresetn] [get_bd_pins axi_lfsr_0/s00_axi_aresetn] [get_bd_pins axi_gpio/s_axi_aresetn] [get_bd_pins usb_interface_0_axi_periph/M01_ARESETN] [get_bd_pins usb_interface_0_axi_periph/M02_ARESETN]
...
assign_bd_address -offset 0xA1000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces usb_interface_0/M00_AXI] [get_bd_addr_segs axi_gpio/S_AXI/Reg] -force
...
assign_bd_address -offset 0xA1000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces VexRiscv_Core_0/M_DATA_AXI] [get_bd_addr_segs axi_gpio/S_AXI/Reg] -force
