...
proc create_ipi_design { offsetfile design_name } {
	...
	set axi_lfsr_0 [ create_bd_cell -type ip -vlnv user.org:user:axi_lfsr:1.0 axi_lfsr_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:axi_lfsr:1.0]]]]
